...
def generate_question(topic, core_standard):
    if not topic.strip() or not core_standard.strip():
...
with gr.Blocks(theme=gr.themes.Soft()) as demo:
    ...
    generate_button.click(fn=generate_question, inputs=[topic, core_standard], outputs=[context, question, rubric, TS_instance])
